...
/**
 * Configures the Nacos Log4j2 logging configuration additively into an existing LoggerContext.
 *
...
public class NacosLog4j2Configurator {
    ...
    /**
     * Configure the LoggerContext with Nacos Log4j2 configuration.
